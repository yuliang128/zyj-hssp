...
databaseChangeLog(logicalFilePath:"2016-06-09-init-table-migration.groovy"){
    ...
    changeSet(author: "hailor", id: "20160609-hailor-21") {
        ...
        createTable(tableName: "SYS_USER_ROLE"){
            ...
            column(name:"START_ACTIVE_DATE",type: "datetime")
            column(name:"END_ACTIVE_DATE",type: "datetime")
            column(name:"OBJECT_VERSION_NUMBER",type:"BIGINT",defaultValue: "1")
            column(name: "REQUEST_ID", type: "bigint", defaultValue : "-1")
            column(name: "PROGRAM_ID", type: "bigint", defaultValue : "-1")
            column(name: "CREATED_BY", type: "bigint", defaultValue : "-1")
        ...
        if(!mhi.isDbType('postgresql')){
            addUniqueConstraint(columnNames:"ROLE_ID,USER_ID,COMPANY_ID",tableName:"SYS_USER_ROLE",constraintName: "SYS_USER_ROLE_U1")
        }else{
            addUniqueConstraint(columnNames:"SUR_ID,ROLE_ID,USER_ID,COMPANY_ID",tableName:"SYS_USER_ROLE",constraintName: "SYS_USER_ROLE_U1")
        }
