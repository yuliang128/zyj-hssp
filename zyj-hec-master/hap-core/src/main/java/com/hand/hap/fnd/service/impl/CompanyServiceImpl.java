...
public class CompanyServiceImpl extends BaseServiceImpl<Company> implements ICompanyService {
    ...
    public List<Company> batchUpdate(IRequest request, List<Company> list) {
        ...
        criteria.update(Company.FIELD_COMPANY_SHORT_NAME, Company.FIELD_COMPANY_FULL_NAME, Company.FIELD_COMPANY_TYPE,
                Company.FIELD_COMPANY_LEVEL_ID, Company.FIELD_PARENT_COMPANY_ID,
                Company.FIELD_CHIEF_POSITION_ID, Company.FIELD_START_DATE_ACTIVE, Company.FIELD_END_DATE_ACTIVE,
                Company.FIELD_ZIPCODE, Company.FIELD_FAX, Company.FIELD_PHONE, Company.FIELD_CONTACT_PERSON,
                Company.FIELD_ADDRESS);
