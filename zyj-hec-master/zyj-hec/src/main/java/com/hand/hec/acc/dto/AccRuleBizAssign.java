...
@Table(name = "acc_rule_biz_assign")
public class AccRuleBizAssign extends BaseDTO {

     public static final String FIELD_ASSIGIN_ID = "assiginId";
