...
public interface SscTaskPoolPrepareMapper extends Mapper<SscTaskPoolPrepare>{
	/**
	 *根据流程代码，秒速，单据类别查询
	 ...
	 */
	List<SscTaskPoolPrepare> selectSscTaskPoolPrepare(@Param("docNumber") String docNumber,
