...
/**
 * \* Created with IntelliJ IDEA. \* User: MouseZhou \* Date: 2018/9/6 \* Time: 12:20 \* To change
...
@ToString
@NoArgsConstructor
public class PageLayout extends BaseDTO {
    ...
    @Length(max = 200)
    private String layoutType;// 布局组件类型
    ...
    @Length(max = 200)
    private String templateFlag;// 模板标志，是否从模板中带出
    ...
    private Long margintop;// 上边距

    private Long marginleft;// 左边距
    ...
    public String getWriteBackProgram() {
        return writeBackProgram;
    }

    public void setWriteBackProgram(String writeBackProgram) {
        this.writeBackProgram = writeBackProgram;
    }

    public PageLayoutBasic convertBasic() {
        PageLayoutBasic basic = new PageLayoutBasic();
        basic.setLayoutId(this.getLayoutId());
        basic.setPageId(this.getPageId());
        ...
        basic.setWriteBackProgram(this.getWriteBackProgram());
        basic.setEntityId(this.getEntityId());
        basic.setEntityName(this.getEntityName());
    ...
    public PageLayoutForm convertForm() {
    ...
    public PageLayoutGrid convertGrid() {
    ...
    public PageLayoutTab convertTab() {
    ...
    public PageLayout convertLayout(PageLayoutBasic basic, PageLayoutForm form, PageLayoutGrid grid,
                    PageLayoutTab tab) {
        this.setLayoutId(basic.getLayoutId());
        this.setPageId(basic.getPageId());
        ...
        this.setWriteBackProgram(basic.getWriteBackProgram());
        this.setEntityId(basic.getEntityId());
        this.setEntityName(basic.getEntityName());
    ...
    public PageLayout(TpltLayout tpltLayout, Long pageId) {

        this.setPageId(pageId);
        this.setTemplateFlag("Y");
        this.setLayoutSequence(tpltLayout.getLayoutSequence());
        this.setLayoutCode(tpltLayout.getLayoutCode());
        this.setLayoutDesc(tpltLayout.getLayoutDesc());
        this.setLayoutType(tpltLayout.getLayoutType());
        this.setParentLayoutId(tpltLayout.getParentLayoutId());
        this.setLayoutLevel(tpltLayout.getLayoutLevel());
        this.setDataset(tpltLayout.getDataset());
        this.setId(tpltLayout.getId());
        this.setTabGroupNumber(tpltLayout.getTabGroupNumber());
        this.setWidth(tpltLayout.getWidth());
        this.setHeight(tpltLayout.getHeight());
        this.setMarginwidth(tpltLayout.getMarginwidth());
        this.setMarginheight(tpltLayout.getMarginheight());
        this.setStyle(tpltLayout.getStyle());
        this.setHidden(tpltLayout.getHidden());
        this.setBusinessCategory(tpltLayout.getBusinessCategory());
        this.setParentBusinessCategory(tpltLayout.getParentBusinessCategory());
        this.setRefTable(tpltLayout.getRefTable());
        this.setRefField(tpltLayout.getRefField());

        this.setPrompt(tpltLayout.getPrompt());
        this.setTitle(tpltLayout.getTitle());
        this.setColumnNum(tpltLayout.getColumnNum());
        this.setRowNum(tpltLayout.getRowNum());
        this.setLabelwidth(tpltLayout.getLabelwidth());
        this.setLabelseparator(tpltLayout.getLabelseparator());

        this.setNavbar(tpltLayout.getNavbar());

        this.setCloseable(tpltLayout.getCloseable());
        this.setDisabled(tpltLayout.getDisabled());
        this.setRef(tpltLayout.getRef());
        this.setSelected(tpltLayout.getSelected());
        this.setBodystyle(tpltLayout.getBodystyle());
        this.setTabstyle(tpltLayout.getTabstyle());


        this.set__id(tpltLayout.get__id());
        this.set__status(tpltLayout.get__status());
        this.set__tls(tpltLayout.get__tls());
        this.setSortname(tpltLayout.getSortname());
        this.setSortorder(tpltLayout.getSortorder());
        this.set_token(tpltLayout.get_token());
        this.setRequestId(tpltLayout.getRequestId());
        this.setProgramId(tpltLayout.getProgramId());
        this.setObjectVersionNumber(tpltLayout.getObjectVersionNumber());
        this.setLastUpdateLogin(tpltLayout.getLastUpdateLogin());
        this.setCreatedBy(tpltLayout.getCreatedBy());
        this.setCreationDate(tpltLayout.getCreationDate());
        this.setLastUpdatedBy(tpltLayout.getLastUpdatedBy());
        this.setLastUpdateDate(tpltLayout.getLastUpdateDate());
        this.setAttributeCategory(tpltLayout.getAttributeCategory());
        this.setAttribute1(tpltLayout.getAttribute1());
        this.setAttribute2(tpltLayout.getAttribute2());
        this.setAttribute3(tpltLayout.getAttribute3());
        this.setAttribute4(tpltLayout.getAttribute4());
        this.setAttribute5(tpltLayout.getAttribute5());
        this.setAttribute6(tpltLayout.getAttribute6());
        this.setAttribute7(tpltLayout.getAttribute7());
        this.setAttribute8(tpltLayout.getAttribute8());
        this.setAttribute9(tpltLayout.getAttribute9());
        this.setAttribute10(tpltLayout.getAttribute10());
        this.setAttribute11(tpltLayout.getAttribute11());
        this.setAttribute12(tpltLayout.getAttribute12());
        this.setAttribute13(tpltLayout.getAttribute13());
        this.setAttribute14(tpltLayout.getAttribute14());
        this.setAttribute15(tpltLayout.getAttribute15());
    }
}
