...
public interface ICshBankAccountPrivilegeService extends IBaseService<CshBankAccountPrivilege>, ProxySelf<ICshBankAccountPrivilegeService>{
	/**
	 ...
	 * @author bo.zhang05@hand-china.com 2019-02-22 15:40
	 */
	List<CshBankAccountPrivilege> selectCshBankAccount(@Param("accEntityId") BigDecimal accEntityId, @Param("bankCode") String bankCode,
													   @Param("bankName") String bankName, IRequest iRequest);
	/**
	 ...
	 */
	List<CshBankAccountPrivilege> selectCshBankAccountPrivilege(@Param("bankAccountId") BigDecimal bankAccountId,IRequest iRequest);
