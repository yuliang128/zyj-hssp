...
@Table(name = "bpm_tplt_layout_button")
public class TpltLayoutButton extends BaseDTO {
    ...
    @Length(max = 300)
    @Transient
    @JoinCode(code = "BPM.BUTTON_TYPE", joinKey = TpltLayoutButton.FIELD_BUTTON_TYPE)
    private String buttonTypeDesc;//按钮类型描述
    ...
    @Transient
    @JoinCode(code = "BPM.BUTTON_OPERATOR_TYPE", joinKey = TpltLayoutButton.FIELD_OPERATION_TYPE)
