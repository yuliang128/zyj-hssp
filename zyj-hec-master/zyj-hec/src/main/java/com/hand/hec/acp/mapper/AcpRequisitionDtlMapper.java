 ...
 */
public interface AcpRequisitionDtlMapper extends Mapper<AcpRequisitionDtl> {
     ...
     * @return
     */
    List<AcpRequisitionDtl> queryByLineId(AcpRequisitionDtl acpRequisitionDtl);

    /**
     * 根据付款申请行ID 获取行金额总和
     *
     * @param requisitionLnsId 付款申请行ID
     * @author guiyuting 2019-05-06 15:13
     * @return
     */
    BigDecimal getTotalAmount(@Param("requisitionLnsId") Long requisitionLnsId);
     ...
     * @return
     */
    List<AcpRequisitionDtl> queryByHeaderId(@Param("requisitionHdsId") Long requisitionHdsId);
     ...
     * @return
     */
    List<AcpRequisitionDtl> queryFromReport(AcpRequisitionDtl acpRequisitionDtl);
     ...
     * @version 1.0
     **/
    List<AcpRequisitionDtl> queryAllByLnsId(@Param("requisitionLnsId") Long requisitionLnsId);
