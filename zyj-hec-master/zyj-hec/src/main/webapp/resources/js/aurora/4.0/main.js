...
Ext.onReady(function () {
                            ...
                            funLv2Item.hoverTask = new Ext.util.DelayedTask(function () {
                                ...
                                Ext.each(window.currentLv3FunArea.query('li.fun-item-lv3'), function (funLv3Item) {
                                    ...
                                    Ext.get(funLv3Item).on('click', function (e4) {
                                        ...
                                        var funName = Ext.get(funLv3Item).getAttribute('fun-name');
    ...
    Ext.get('sidebar-toggle-icon').on('click', function (e) {
        e.stopEvent();
        e.stopPropagation();

        Ext.get('page-sidebar').toggleClass('page-side-toggle-on');
        Ext.get('page-sidebar').toggleClass('page-side-toggle-off');
