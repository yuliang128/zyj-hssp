var Layout = function() {
    ...
    i = function() {
        ...
        if (t.hasClass("page-footer-fixed") === !0 && t.hasClass("page-sidebar-fixed") === !1) {
            ...
            if (t.hasClass("page-sidebar-fixed")) e = n() - 10,
            t.hasClass("page-footer-fixed") === !1 && (e -= $(".page-footer").outerHeight(!0));
            else {
    ...
    t = function(e, a) {
        ...
        if ("click" === e || "set" === e ? a = $(a) : "match" === e && t.find("li > a").each(function() {
            ...
            parseInt(t.data("slide-speed")),
            t.data("keep-expanded");
            t.find("li.active").removeClass("active"),
            t.find("li > a > .selected").remove(),
            t.hasClass("page-sidebar-menu-hover-submenu") === !1 ? t.find("li.open").each(function() {
        ...
        function(e) {
            if (! (App.getViewPort().width >= s && 1 === $(this).parents(".page-sidebar-menu-hover-submenu").size())) {
                ...
                if (!$(this).next().hasClass("sub-menu always-open")) {
                    ...
                    var l = -200;
                    n.is(":visible") ? ($(".arrow", $(this)).removeClass("open"), $(this).parent().removeClass("open"), n.slideUp(p,
                    function() {
                        r === !0 && $("body").hasClass("page-sidebar-closed") === !1 && ($("body").hasClass("page-sidebar-fixed") ? o.slimScroll({
                            scrollTo: t.position().top
                        }) : App.scrollTo(t, l)),
                        i()
                    })) : ($(".arrow", $(this)).addClass("open"), $(this).parent().addClass("open"), n.slideDown(p,
                    function() {
                        r === !0 && $("body").hasClass("page-sidebar-closed") === !1 && ($("body").hasClass("page-sidebar-fixed") ? o.slimScroll({
                            scrollTo: t.position().top
                        }) : App.scrollTo(t, l)),
    ...
    r = function() {
        ...
        0 === $(".page-sidebar-fixed").size() ? void i() : void(App.getViewPort().width >= s && (e.attr("data-height", n()), App.initSlimScroll(e), i()))
    },
    p = function() {
        var e = $("body");
    ...
    d = function() {
        var e = $("body");
        $.cookie && "1" === $.cookie("sidebar_closed") && App.getViewPort().width >= s && ($("body").addClass("page-sidebar-closed"), $(".page-sidebar-menu").addClass("page-sidebar-menu-closed")),
        ...
        function(a) {
            ...
            $(".fun-list-lv1").getNiceScroll().resize();//当菜单缩小时使用这个方法对滚动条进行重绘
        }),
        p(),
