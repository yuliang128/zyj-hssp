...
<a:screen xmlns:c="aurora.application.action" xmlns:p="uncertain.proc" xmlns:a="http://www.aurora-framework.org/application" xmlns:s="aurora.plugin.script" trace="true">
    <a:view>
        ...
        <script><![CDATA[
            ...
            function ACP3100_lnsGridAddFunc() {
                ...
                if (dataSet.validate()) {
                    ...
                    if (selectRecords && selectRecords.length > 0) {
                        ...
                        var data = {};
                        lineDataInit(data,headerRecord);
                        $au('ACP3100_acpRequisitionLnsDs').create(data);
                    }
                }
            }

            function lineDataInit(data,headerRecord){
                data['lineNumber'] = ACP3100_getNextLineNumber($au('ACP3100_acpRequisitionLnsDs'));
            ...
            function ACP3100_reportScheduleAddWindowFunc() {
                new Aurora.Window({
                    url: $au('ACP3100_exp_report_schedule_link').getUrl() + '?employeeId=$[/model/headerInfo/records/record/@employeeId]&moPayReqTypeId=$[/model/headerInfo/records/record/@moPayReqTypeId]&currencyCode=$[/model/headerInfo/records/record/@currencyCode]',
                    id: 'ACP3100_acp_requisition_from_report_window',
                    title: '$[l:exp_report.reimbursement_bill]',
                    width: 1020,
                    side: 'right'
                });
            }
            ...
            function ACP3100_backRequisition() {
                if (Aurora.CmpManager.get('ACP3100_acp_requisition_maintain_main_window')) {
                    $au('ACP3100_acp_requisition_maintain_main_window').close();
                }
                if (Aurora.CmpManager.get('ACP3100_acp_requisition_new_maintain_main')) {
                    $au('ACP3100_acp_requisition_new_maintain_main').close();
                }
            }
        ...
        <a:dataSets>
            ...
            <a:dataSet id="ACP3100_acpRequisitionHdsDs" baseUrl="/acp/requisition-hd" submitUrl="$[/request/@context_path]/acp/requisition-hd/submit">
                ...
                <a:fields>
                    ...
                    <a:field name="accEntityName" displayField="accEntityName" options="ACP3100_acpRequisitionAccDs" prompt="gld_accounting_entity.acc_entity_name" required="true" returnField="accEntityId" valueField="accEntityId"/>
                    ...
                    <a:field name="positionName" displayField="positionName" options="ACP3100_acpRequisitionPositionDs" prompt="acp_acp_requisition_hds.position_id" required="true" returnField="positionId" valueField="positionId">
                        <a:mapping>
                    ...
                    <a:field name="paymentUsedeName" displayField="paymentUsedeName" options="ACP3100_paymentUsedesDs" prompt="acp_mo_pay_req_type.define_usage" required="true" returnField="paymentUsedeId" valueField="paymentUsedeId"/>
                    ...
                    <a:field name="payeeName" lovCode="GLD_PAYEE_V_LOV" prompt="csh_payment_requisition_hd.partner_id" required="true" title="csh_payment_requisition_hd.partner_id">
                        <a:mapping>
                ...
                <a:events>
                    <a:event name="update" handler="ACP3100_hdsUpdateFunc"/>
                    <a:event name="submitsuccess" handler="ACP3100_submitSuccessFunc"/>
                </a:events>
            </a:dataSet>
            <a:dataSet id="ACP3100_acpRequisitionLnsDs" autoPageSize="true" autoQuery="true" bindName="lines" bindTarget="ACP3100_acpRequisitionHdsDs" baseUrl="/acp/requisition-ln" queryUrl="$[/request/@context_path]/acp/requisition-ln/query?requisitionHdsId=$[/parameter/@requisitionHdsId]&amp;payeeId=$[/model/headerInfo/records/record/@payeeId]" selectable="true">
                ...
                <a:events>
                    <a:event name="update" handler="ACP3100_lnsUpdateFunc"/>
                    <a:event name="remove" handler="ACP3100_lnsRemoveFunc"/>
        ...
        <a:screenBody>
            <a:form column="1" title="$[/model/headerInfo/records/record/@moPayReqTypeName]">
                <a:formToolbar>
                    ...
                    <a:button click="ACP3100_deleteRequisition" text="hap_delete_draft" width="80"/>
                    <a:button click="ACP3100_saveRequisition" text="hap_save_draft" width="80"/>
                    <a:hBox id="saveAcpReqDiv" width="240">
                        ...
                        <a:button click="ACP3100_submitRequisition" text="hap_submit_approval" width="80"/>
                        <a:button id="ACP3100_wflPreviewBtn" click="ACP3100_wflPreview" text="wfl.preview" width="80"/>
                    </a:hBox>
            ...
            <a:form padding="0" showmargin="false" title="acp_requisition_hds.requisition_lns">
                <a:grid id="ACP3100_requisition_lns_grid" autoAdjustHeight="true" bindTarget="ACP3100_acpRequisitionLnsDs" marginHeight="1" marginWidth="12" navBar="true" showRowNumber="false">
                    <a:toolBar>
                        <a:button click="ACP3100_lnsGridAddFunc" type="add"/>
                        <a:button type="delete"/>
                    </a:toolBar>
                    <a:columns>
                        <a:column name="lineNumber" align="center" width="80"/>
                        <a:column name="moCshTrxClassName" align="center" editor="ACP3100_comboBox" width="100"/>
                        <a:column name="payeeCategoryName" align="center" editor="ACP3100_comboBox" width="100"/>
                        <a:column name="payeeName" align="center" editor="ACP3100_lov" width="100"/>
                        <a:column name="amount" align="right" editor="ACP3100_numberField" renderer="Aurora.formatMoney" width="100"/>
                        <a:column name="paymentMethodName" align="center" editor="ACP3100_comboBox" width="100"/>
                        <a:column name="requisitionPaymentDate" align="center" editor="ACP3100_datePicker" renderer="Aurora.formatDate" width="100"/>
                        <a:column name="accountNumber" align="left" editor="ACP3100_lov" width="150"/>
                        <a:column name="accountName" align="left" width="150"/>
                    </a:columns>
                    <a:editors>
                        <a:numberField id="ACP3100_numberField" allowFormat="true" allowNegative="false"/>
                        <a:textField id="ACP3100_textField"/>
                        <a:comboBox id="ACP3100_comboBox"/>
                        <a:lov id="ACP3100_lov"/>
                        <a:textArea id="ACP3100_textArea"/>
                        <a:datePicker id="ACP3100_datePicker"/>
                    </a:editors>
                    <a:events>
                        <a:event name="cellclick" handler="ACP3100_cellClickFunc"/>
                    </a:events>
                </a:grid>
            </a:form>
            <#if headerInfo.paymentType=='REPORT'>
                <a:form marginWidth="10" padding="0" showmargin="false" title="exp_report.reimbursement_bill">
                    <a:grid id="ACP3100_reportRequisition_dtl_grid" autoAdjustHeight="true" bindTarget="ACP3100_acpReportRequisitionDtlDs" height="600" marginWidth="12" navBar="true" showRowNumber="false">
                        <a:toolBar>
                            <a:button click="ACP3100_reportScheduleAddWindowFunc" type="add"/>
                            <a:button type="delete"/>
                        </a:toolBar>
                        <a:columns>
                            ...
                            <a:column name="scheduleDueDate" align="center" width="100" renderer="Aurora.formatDate"/>
                        ...
                        <a:editors>
                            <a:numberField id="ACP3100_scheduleNumberField" allowFormat="true" allowNegative="false"/>
                        </a:editors>
                    </a:grid>
                </a:form>
            <#elseif headerInfo.paymentType=='CONTRACT'>
                <a:form marginWidth="10" padding="0" showmargin="false" title="con_contract.contract_settlement">
                    <a:grid id="ACP3100_contractRequisition_dtl_grid" autoAdjustHeight="true" bindTarget="ACP3100_acpContractRequisitionDtlDs" height="600" marginWidth="12" navBar="true" showRowNumber="false">
                        <a:toolBar>
                            <a:button click="ACP3100_contractScheduleAddWindowFunc" type="add"/>
                            <a:button type="delete"/>
                        </a:toolBar>
                        <a:columns>
                            <a:column name="lineNumber" align="center" width="50"/>
        ...
        ACP3100_acpRequisitionFromRportReady();
        ]]></script>
    </a:view>
</a:screen>
